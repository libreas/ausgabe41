...
\CommentTok{\# Authentification}
\NormalTok{my\_con }\OtherTok{\textless{}{-}}\NormalTok{ bigrquery}\SpecialCharTok{::}\FunctionTok{bq\_auth}\NormalTok{()}
\CommentTok{\# SQL example}
 
\CommentTok{\# Top 10 publishers by the number of articles with Creative Commons}
\CommentTok{\# license in Crossref}
\NormalTok{my\_query }\OtherTok{\textless{}{-}} \StringTok{"SELECT}
\StringTok{  publisher,}
\StringTok{  COUNT(DISTINCT(DOI)) AS n}
\StringTok{FROM}
\StringTok{  \textasciigrave{}subugoe{-}collaborative.cr\_instant.snapshot\textasciigrave{},}
\StringTok{  UNNEST(license) AS license}
\StringTok{WHERE}
\StringTok{  REGEXP\_CONTAINS(license.URL, \textquotesingle{}creativecommons\textquotesingle{})}
\StringTok{GROUP BY}
\StringTok{  publisher}
\StringTok{ORDER BY}
\StringTok{  n DESC}
\StringTok{LIMIT}
\StringTok{  10"}
\CommentTok{\# Call Big Query}
\NormalTok{tb }\OtherTok{\textless{}{-}}\NormalTok{ bigrquery}\SpecialCharTok{::}\FunctionTok{bq\_project\_query}\NormalTok{(}\StringTok{"subugoe{-}collaborative"}\NormalTok{,}
                              \AttributeTok{query =}\NormalTok{ my\_query)}
\CommentTok{\# Download results}
\NormalTok{bigrquery}\SpecialCharTok{::}\FunctionTok{bq\_table\_download}\NormalTok{(tb)}
\CommentTok{\#\textgreater{} \# A tibble: 10 × 2}
\CommentTok{\#\textgreater{}  publisher                                      n}
\CommentTok{\#\textgreater{}  \textless{}chr\textgreater{}                                         \textless{}int\textgreater{}}
\CommentTok{\#\textgreater{}  1 Elsevier BV                                 775742}
\CommentTok{\#\textgreater{}  2 Springer Science and Business Media LLC     745306}
\CommentTok{\#\textgreater{}  3 MDPI AG                                     731206}
\CommentTok{\#\textgreater{}  4 IOP Publishing                              342991}
\CommentTok{\#\textgreater{}  5 Public Library of Science (PLoS)            241008}
\CommentTok{\#\textgreater{}  6 Wiley                                       232884}
\CommentTok{\#\textgreater{}  7 Hindawi Limited                             215611}
\CommentTok{\#\textgreater{}  8 Frontiers Media SA                          212607}
\CommentTok{\#\textgreater{}  9 Informa UK Limited                          166956}
\CommentTok{\#\textgreater{} 10 Walter de Gruyter GmbH                      106683}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=6.5in,height=4.01389in]{media/image2.png}
...
\includegraphics[width=6.5in,height=4.01389in]{media/image1.png}
